...
extern "C"
{
    ...
    {                 // If you have a custom hardware (i.e not the OLR PCB),
        PIN_LED = 22, // set PIN_LED and PIN_AUDIO accordingly
        PIN_AUDIO = 23,
    };
...
//
///////////////////////////////////////////////////////////////////////////////
#define DIG_CTRL_1_PIN 12 // A2 // switch player 1 to PIN and GND
#define DIG_CTRL_2_PIN 14 // A0 // switch player 2 to PIN and GND
#define DIG_CTRL_3_PIN 27 // A3 // switch player 3 to PIN and GND
#define DIG_CTRL_4_PIN 26 // A1 // switch player 4 to PIN and GND
...
#define LED_SEMAPHORE 2 // LED in the Stip used as a Semaphore (Countdown phase)
